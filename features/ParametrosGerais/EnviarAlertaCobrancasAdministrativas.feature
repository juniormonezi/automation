...
Funcionalidade: Enviar Alerta Cobranca Administrativa
  SENDO um temporizador do sistema
  POSSO verificar quais dívidas atingiram determinado marco de acordo com o quadro “Cobranças Administrativas”
  ...
  Esquema do Cenário: Disparo de acao pre definida em Alerta Cobranca Administrativa
    ...
    E identifica dividas com status diferente de “Divida Paga” que atingiram os marcos ativos definidos no painel de “Cobranca Administrativa” da funcionalidade “Parametros Gerais”, contados a partir da data de vencimento da divida
  ...
  Esquema do Cenário: Nenhum registro encontrado Cobranca Administrativa
    Quando O sistema executa a sua rotina diariamente
    E Nao identifica dividas com status diferente de “Divida Paga” que atingiram os marcos ativos definidos no painel de “Cobranca Administrativa” da funcionalidade “Parametros Gerais”, contados a partir da data de vencimento da divida
