#language: pt
Funcionalidade: Alterar Tipos de Benefícios Fiscais
  SENDO o administrador do sistema
  POSSO incluir benefícios fiscais
  PARA QUE eu possa utilizar na negociação das dívidas

  Contexto: Acesso a funcionalidade de alterar de tipo de benefício fiscal
    Dado que estou na funcionalidade de alteração de tipo de benefício fiscal

  Cenário: Alteração de benefício fiscal com sucesso
    Quando tipo de beneficio fiscal altero os campos
      | Nome do Tributo | Ano  | Data Inicial | Data Final | Descrição                 |
      | Tributo001      | 2018 |     01012018 |   31122018 | Descrição sobre o tributo |
    E beneficio fiscal aciono a opção salvar
    Então  o beneficio fiscal persiste as informações na base de dados
    E sistema exibe a mensagem "Registro salvo com sucesso."
